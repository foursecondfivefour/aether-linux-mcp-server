//! AetherServer — the central MCP server with all 12 tools registered.
//! stdio transport, JSON-RPC via rmcp, feature-gate enforcement, audit logging.
...
impl ServerHandler for AetherServer {
    fn get_info(&self) -> ServerInfo {
        ServerInfo {
            ...
            instructions: Some(
                "AETHER_02 — Full-spectrum Linux management server.\n\
