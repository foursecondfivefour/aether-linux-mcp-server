...
CASES: list[tuple[str, str, dict, str]] = [
    ...
    ("service_manager", "list_sockets", {}, "MOCK"),
    ("service_manager", "mask", {"service": "ssh"}, "Force required"),
    ...
    ("network_manager", "address_add", {"interface": "eth0", "address": "192.0.2.10/24"}, "Force required"),
    ("network_manager", "wireguard_list", {}, "MOCK"),
    ...
    ("user_management", "group_info", {"name": "root"}, "MOCK"),
    ("user_management", "ssh_authorized_keys_add", {"username": "aether", "home": "/tmp/aether-home", "key": "ssh-ed25519 AAAATEST", "dry_run": True}, "DRY-RUN"),
    ("user_management", "user_create", {"username": "aether-test", "force": True}, "Feature disabled"),
    ("security_audit", "aslr_status", {}, "ok"),
    ("security_audit", "kernel_hardening", {}, "ok"),
    ("security_audit", "file_integrity_check", {"path": "/etc/os-release", "dry_run": True}, "DRY-RUN"),
    ("security_audit", "firewall_status", {"dry_run": True}, "DRY-RUN"),
    ("hardware_control", "usb_devices", {}, "MOCK"),
    ("hardware_control", "pci_list", {}, "MOCK"),
    ("hardware_control", "irq_set_affinity", {"irq": "1", "mask": "1", "dry_run": True}, "DRY-RUN"),
    ...
    ("system_config", "sysctl_set", {"key": "vm.swappiness", "value": "10"}, "Force required"),
    ("system_config", "etc_config_write", {"path": "/etc/aether-test.conf", "content": "x", "dry_run": True}, "DRY-RUN"),
